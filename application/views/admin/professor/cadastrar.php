            ...
            <div class="panel panel-primary">
               <div class="panel-heading" style="background:#364956;">
                  <h4 class="panel-title">
                     <center><i class="fa fa-user-plus"></i> Cadastro de Professores</center>
                  </h4>
               </div>
               <div class="panel-body">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-8">
                        <input type="text" class="form-control" name="materia" placeholder="Matéria" value="<?=set_value('materia')?>">
                     </div>
                  </div>
                  <div class="form-group">
                     <label for="inputPassword3" class="col-sm-2 control-label">E-mail</label>
                     <div class="col-sm-8">
                        <input type="email" class="form-control" name="email" placeholder="E-mail" value="<?=set_value('email')?>">
                     </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" name="button" class='btn btn-info bt'><i class="fa fa-check"></i> Cadastrar</button>
